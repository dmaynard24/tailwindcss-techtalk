    ...
    <div>
      ...
      <table className="text-sm text-left md:text-lg 2xl:text-2xl">
        ...
        <tbody>
          ...
          <tr className="border-b border-gray-200">
            <td className="pr-2 py-2 align-top xl:pr-8 2xl:pr-2 2xl:py-4">HTML littered with CSS classes can be lengthy and hard to scan</td>
            <td className="px-2 py-2 align-top border-l border-l-gray-200 xl:px-8 2xl:px-4 2xl:py-4">CSS can become lengthy and hard to quickly scan</td>
          </tr>
          <tr className="border-b border-gray-200">
            <td className="pr-2 py-2 align-top xl:pr-8 2xl:pr-2 2xl:py-4">HTML becomes cluttered with CSS classnames, DOM takes longer to load</td>
            <td className="px-2 py-2 align-top border-l border-l-gray-200 xl:px-8 2xl:px-4 2xl:py-4">CSS can become cluttered with styles, stylesheets take longer to load</td>
          </tr>
          <tr className="border-b border-gray-200">
